...
export class ActionsService {
  ...
  followUser(username: string): Observable<ProfileResponse> {
    return this.apiService.post<ProfileResponse, Object>('/profiles/' + username + '/follow', {});
  }
  ...
  favorite(slug: string): Observable<SingleArticleResponse> {
    return this.apiService.post<SingleArticleResponse, Object>('/articles/' + slug + '/favorite', {});
  }
